...
/* ──────────────────────────────────────────────────────────────
   HERO — Portal Acadêmico + dois cards (Sou Calouro, Tutoriais)
   ────────────────────────────────────────────────────────────── */
function HeroIntro() {
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 pt-12 pb-20 lg:px-12 lg:pt-20 lg:pb-28">
        ...
        {/* Dois cards: Sou Calouro / Tutoriais */}
        <motion.div
          ...
          {[
            {
              ...
              gradient: "linear-gradient(135deg, #6E3AFF 0%, #FF4D2E 100%)",
            },
            {
              no: "02",
              tag: "Guias rápidos",
              ...
              gradient: "linear-gradient(135deg, #00B894 0%, #FFB800 100%)",
            },
          ].map((c, i) => (
            <Link
              key={c.no}
...
/* ──────────────────────────────────────────────────────────────
   ATALHOS RÁPIDOS — tiles coloridos com gradientes
   ────────────────────────────────────────────────────────────── */
          ...
          {items.map((it, i) => {
            ...
            return (
              <Reveal key={it.label} delay={(i % 5) * 0.04}>
                <motion.button
                  whileHover={{ y: -2 }}
                  className="group flex h-full min-h-[180px] w-full flex-col justify-between border-b border-r border-[#e5e5e5] bg-white p-6 text-left transition-colors hover:bg-[#fafafa]"
                >
...
/* ──────────────────────────────────────────────────────────────
   PRAZOS E OPORTUNIDADES — 4 cards "ABERTO"
   ────────────────────────────────────────────────────────────── */
function PrazosOportunidades() {
  const items = [
    {
...
/* ──────────────────────────────────────────────────────────────
   ESTUDE NA UNIMONTES — split editorial com 4 chamadas
   ────────────────────────────────────────────────────────────── */
                ...
                return (
                  ...
                  >
                    ...
                    <div className="col-span-9">
                      ...
                      <p className="mt-3 text-[16px] leading-[1.6] text-white/65">
                        {it.desc}
                      </p>
                    </div>
...
/* ──────────────────────────────────────────────────────────────
   NOTÍCIAS E DESTAQUES — 3 cards editoriais
   ────────────────────────────────────────────────────────────── */
function Noticias() {
  const items = [
    {
  ...
  return (
    <section className="bg-white py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        ...
        {/* Decoração final — link para mapa/compass */}
        <Reveal>
