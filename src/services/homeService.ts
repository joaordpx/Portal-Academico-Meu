...
export async function getOportunidades(): Promise<Oportunidade[]> {
    return [
        { id: 1, title: "Semana de Extensão Universitária", tipo: "Evento", prazo: "30/05/2026", publico: "Aberto a todos", campus: "Vila Mauricéia" },
        { id: 2, title: "Edital de Monitoria — Sistemas de Informação", tipo: "Edital", prazo: "10/06/2026", publico: "Graduação SI", campus: "Bloco G" },
        { id: 3, title: "Inscrição para Estágio — Administração", tipo: "Estágio", prazo: "05/06/2026", publico: "Administração", campus: "Vila Mauricéia" },
        { id: 4, title: "Curso gratuito: Excel Avançado", tipo: "Curso", prazo: "20/06/2026", publico: "Comunidade", campus: "EAD" },
    ];
}

export async function getNoticias(): Promise<Noticia[]> {
    return [
        { id: 1, cat: "Extensão", catColor: "#6E3AFF", bg: "#ECE3FF", img: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=900", title: "Projeto de extensão leva atendimento jurídico a comunidades rurais", desc: "Alunos do curso de Direito participam de ação que beneficiou mais de 200 famílias na região norte de Minas.", date: "20/05/2026" },
